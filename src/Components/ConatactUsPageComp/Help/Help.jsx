      ...
      <div className="container mx-auto px-4 grid gap-10 sm:grid-cols-2 xl:grid-cols-3">
        {ContactData.map((item) => (
          ...
          >
            <div
              data-aos="fade-left"
              className="text-center bg-cover bg-no-repeat bg-center rounded-3xl p-6 sm:p-6 lg:p-10 flex flex-col justify-center items-center w-full min-h-[300px] sm:min-h-[305px] lg:min-h-[400px] transition-transform duration-300 hover:scale-[1.02]"
