...
const Philosophy = () => {
  return (
    <section className="py-12 space-y-10 relative z-10 overflow-hidden">
       <img src={BgImg} alt="BgLeaf" className="absolute top-2/3 z-0 pointer-events-none" />
      {/* Heading */}
      ...
      <div className="container grid grid-cols-1 md:grid-cols-3 gap-8 pt-20 z-10">
        {dataList.map((item) => (
          <div
            key={item.id}
            className="bg-white rounded-3xl shadow-inner py-6 px-16 text-center transition duration-300 hover:shadow-lg hover:-translate-y-1"
          >
