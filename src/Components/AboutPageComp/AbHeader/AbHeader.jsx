...
const AbHeader = () => {
  return (
    <div className="relative">
      <section
        data-aos="fade"
        className="relative w-full h-[500px] sm:h-[600px] md:h-[700px] xl:h-[640px] overflow-hidden xl:rounded-br-[410px]"
      >
        {/* Background Images */}
        <img
          src={MAbHeroBg}
      ...
      <img
        src={Corner}
        alt="Decorative Corner"
        className="hidden xl:block absolute bottom-0 right-0 w-20 md:w-40 lg:w-80 pointer-events-none"
      />
    </div>
  );
};
